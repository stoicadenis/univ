...
namespace Exemplu
{
    public class Intrebari
    {
        ...
        private string tip_intrebare;
        private string intrebare;
        private int nr_variante_rasp;
        private string[] variante_rasp;
        ...
        public Intrebari(int nr_intrebare, string tip_intrebare, string intrebare,
            int nr_variante_rasp, string[] variante_rasp, string linkPoza, string raspuns_corect)
        {
